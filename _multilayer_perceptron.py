...
class BaseMultilayerPerceptron(BaseEstimator, metaclass=ABCMeta):
    ...
    def __init__(self, hidden_layer_sizes, activation, solver,
                 ...
                 n_iter_no_change, max_fun, weights, intercepts):
    ...
    def _initialize(self, y, layer_units, dtype):
        ...
        # # This is Scikit learn default code
        # for i in range(self.n_layers_ - 1):
        ...
        if self.weights == None:
            ...
            print ('\t\t\t>> Applying weights from previous iteration')
            # print ('%s' % self.weights[0][0])
            # # print ('%s' % self.intercepts[0])
            # print ('................................')
            self.coefs_ = self.weights
            self.intercepts_ = self.intercepts
...
class MLPClassifier(ClassifierMixin, BaseMultilayerPerceptron):
    ...
    def __init__(self, hidden_layer_sizes=(100,), activation="relu", *,
                 ...
                 epsilon=1e-8, n_iter_no_change=10, max_fun=15000, weights=None, intercepts=None):
        ...
        super().__init__(
            ...
            n_iter_no_change=n_iter_no_change, max_fun=max_fun, weights=weights, intercepts=intercepts)
